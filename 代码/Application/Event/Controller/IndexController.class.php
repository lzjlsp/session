...
class IndexController extends Controller
{
            ...
            array(
                'left' =>
                    array(
						...
						array('tab' => 'search', 'title' => L('搜索'), 'href' => U('event/index/search')),
                    ),
            );
	...
	public function search($page = 1, $type_id = 0, $keyword = '',$district=0,$city=0,$province){
	 ...
	 $type_id = intval($type_id);
        ...
        foreach ($content as &$v) {
			...
			/*改正*/
			$v['district']=D('Addons://ChinaCity/District')->getFullName($v['district']);
     ...
     * autor:xjw129xjt
     */
    public function doPost($id = 0, $cover_id = 0, $title = '', $explain = '', $sTime = '', $eTime = '',$district=0 ,$address = '', $limitCount = 0, $deadline = '', $type_id = 0)
    {
        if (!is_login()) {
     ...
     * autor:xjw129xjt
     */
    public function doSign($event_id, $name, $phone, $info)
    {
        if (!is_login()) {
